...
public class DistanceMatrixExample {
    ...
    public static void main(String[] args) throws Exception {
        String address = "Caerleon Rd Llanfrechfa Cwmbran";
        String destinations = "Caerleon Rd Llanfrechfa Cwmbran";
        String key1 = "hSDDUzoJ33JfbRdRDqaiLwoC4qEAkh5OxNFaTcJidQMOgcfHeQRdtC0sWbiyMtq1";
